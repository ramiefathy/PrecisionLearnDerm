...
vi.mock("../lib/api", () => ({
  api: {
    ai: {
      chatExplain: vi.fn().mockResolvedValue({ answerMarkdown: 'I can help with dermatology-related inquiries only. Please ask a dermatology-related question.', citations: [], domain: 'out-of-scope' })
    }
  }
}));
